...
case $(uname -m) in
    x86_64|AMD64)
        ...
        bash "$SCRIPT_DIR/build_install_blasfeo.sh" X64_INTEL_SKYLAKE_X x64_avx512 c:/opt/blasfeo_x64_avx512
        ;;
    aarch64|arm64|ARM64)
        bash "$SCRIPT_DIR/build_install_blasfeo.sh" ARMV8A_APPLE_M1 arm64 c:/opt/blasfeo_arm64
        ;;
esac
