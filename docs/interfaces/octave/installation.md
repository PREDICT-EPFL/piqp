...
follow the instructions to install Eigen and prerequistes at [_common/building_from_source_deps.md]
...
```autoload("__piqp__", "[path-to-piqp]/interfaces/octave/piqp_plain.oct")
addpath("[path-to-piqp]/interfaces/octave");
```
